...
class DataLogger(Node):
    def __init__(self):
        ...
        self.csv_file = open('/home/tus/data_log_teleop/No_delay.csv', 'w', newline='')
    ...
    def log_data(self):
        ...
        row = [now, *self.f_m, *self.pos_robot, self.f_v, self.pos_x, self.pos_y, self.v, self.omega, self.h1 + self.h2]
